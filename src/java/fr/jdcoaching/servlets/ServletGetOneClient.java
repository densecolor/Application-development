 ...
 * @author damdam61
 */
public class ServletGetOneClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Query q = session.createQuery("from Utilisateur as u where u.codeu = " + client);
            List<Utilisateur> listeUtilisateur = (List<Utilisateur>) q.list();
