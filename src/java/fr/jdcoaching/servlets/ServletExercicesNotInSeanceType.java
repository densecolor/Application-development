 ...
 * @author edupin
 */
public class ServletExercicesNotInSeanceType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String libST = request.getParameter("pCodeSeanceType");
        //on démarre la transaction de la session
        Transaction t = session.beginTransaction();

        //on entame une requête qui récupère la liste des exercices
        Query q = session.createQuery("from Exercice as ex where ex not in (select org.exercice from Organiser as org where org.seancetype.codest=" + libST + ")");
